...
const SummaryCard = (props: Props) => {
  const getTime = () => {
    ...
    let inMinutes =
      ...
      travelTimeInformation.duration.value / 60 +
  ...
  const PaymentOption = () => {
    return (
      <TouchableOpacity
        ...
        style={tw`justify-between items-center px-5 flex-row`}
      >
  ...
  const ConfirmButton = () => {
    return (
      <View style={tw`w-full`}>
        <TouchableOpacity
          style={tw`mx-5 flex items-center justify-center bg-black`}
        >
          <Text style={tw`text-2xl text-white font-bold py-5`}>
            Confirm Pickup
          </Text>
        </TouchableOpacity>
      </View>
